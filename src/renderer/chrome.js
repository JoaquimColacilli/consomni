...
(function (g) {
  ...
  function topbar(o) {
    ...
    return '<header class="topbar">' +
      '<div class="brand">' + eye(27, hasAttn) + '<span class="wordmark">CONSOMNI</span><span class="brand-ver">' + esc(o.version || 'v1.5.0') + '</span></div>' +
  ...
  function sidebar(o) {
    ...
    return '<aside class="sidebar">' +
      ...
      '<div class="sb-foot">' +
        ...
        '<span class="ver">' + esc(o.version || 'v1.5.0') + '</span></div>' +
    '</aside>';
  }
