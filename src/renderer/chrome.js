...
(function (g) {
  ...
  function topbar(o) {
    ...
    return '<header class="topbar">' +
      '<div class="brand">' + eye(27, hasAttn) + '<span class="wordmark">CONSOMNI</span><span class="brand-ver">' + esc(o.version || 'v1.2.3') + '</span></div>' +
  ...
  function sbItem(it, sub) {
    ...
    if (it.isArchived) {
      return '<div class="sb-item" style="color:var(--text-4)" data-proj="' + esc(it.id || 'archived') + '">' + svg('archive', 13, 1.7) +
  ...
  function sidebar(o) {
    ...
    return '<aside class="sidebar">' +
      ...
      '<div class="sb-foot">' +
        ...
        '<span class="ver">' + esc(o.version || 'v1.2.3') + '</span></div>' +
    '</aside>';
  }
